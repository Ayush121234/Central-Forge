...
const FItFlexChatBot = () => {
  ...
  const calculateBMI = () => {
    ...
    if (heightInMeters > 0) {
      return (parseFloat(arr[1]) / (heightInMeters * heightInMeters)).toFixed(
        2
      );
    }
  ...
  const steps = [
    ...
    },
    {
      id: "5",
      message:
        "Great! We offer personalized workout plans. Would you like to know more?",
      trigger: "9",
    },
    {
      id: "6",
      message:
        "Nutrition is key to fitness. Do you have any specific dietary goals?",
      trigger: "10",
    },
    {
      id: "7",
    ...
    },
    {
      id: "8",
      message:
        "Please specify your query or concern, and I'll do my best to help!",
      trigger: "12",
    },
    {
      id: "bmiInput",
    ...
    },
    {
      id: "13",
      message:
        "Fantastic! Our plans are tailored to your fitness level. Let's get started by visiting the services page!",
      trigger: "endChat",
    },
    {
      id: "14",
    ...
    },
    {
      id: "15",
      message:
        "Awesome! You can check our nutrition section on the website for detailed guidance.",
      trigger: "endChat",
    },
    {
      id: "16",
      message:
        "Thank you for sharing! Our support team will get back to you shortly.",
      trigger: "endChat",
    },
    {
      id: "17",
      message:
        "Thanks for your input! Feel free to explore our website for more information.",
      trigger: "endChat",
    },
    {
      id: "endChat",
